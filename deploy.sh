...
# GitHub (for GHCR image pull)
GITHUB_ORG=tranphu-devops
...
# =============================================================================
# PHASE 7 — Pull or build images
# =============================================================================
hr
info "Phase 7: Docker images"
hr

# Try pulling pre-built GHCR images first (faster than building)
info "Attempting to pull pre-built images from GHCR..."
if docker compose -f "$COMPOSE_FILE" pull --ignore-pull-failures 2>&1 | grep -v "WARNING"; then
  log "Images pulled from GHCR"
else
  warn "Pull failed or partial — will build locally (this takes a few minutes)"
fi
