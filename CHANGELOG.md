...
- **Trang đề thi công khai dùng chung luôn thanh điều hướng và chân trang đó** — `/vi/exams`, `/vi/exams/topics/…`, `/vi/exams/…` trước đây có bộ khung riêng: logo dạng ảnh thay vì chữ, thanh trên chỉ 2 link, chân trang sáng màu với bộ link khác. Giờ giống hệt trang chủ (chỉ thiếu ô chọn ngôn ngữ, vì kho đề mới có tiếng Việt và các trang này cố tình không tải JavaScript nào).
