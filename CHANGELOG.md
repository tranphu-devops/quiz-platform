...
- **`scripts/build-landing-i18n.js`** (dev): sinh 3 file landing từ `landing/index.src.html`. Sửa nội dung landing từ nay làm ở file `.src.html` rồi chạy lại script — xem `CLAUDE.md`.
