...
<style>
  ...
  .preview-avatar-lg { width: 168px; height: 168px; border-radius: 24px; object-fit: cover; display: block; margin: 0 auto 0.75rem; box-shadow: 0 4px 16px rgba(0,0,0,0.12); }
