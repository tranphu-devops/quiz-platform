// Generated by scripts/build-landing-i18n.js from landing/partials/i18n.json —
...
export const CHROME_STRINGS = {
  "en": {
    ...
    "nav.contact": "Contact",
    "nav.cta": "Get started",
    "footer.tagline": "A smart online testing platform",
  ...
  "ja": {
    ...
    "nav.contact": "お問い合わせ",
    "nav.cta": "今すぐ始める",
    "footer.tagline": "スマートなオンライン試験プラットフォーム",
    "footer.builtBy": "開発者"
  }
}
