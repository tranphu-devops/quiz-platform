<script>
  ...
  const I = {
    ...
    key:      `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="11" r="3"/><path d="M7.2 8.8L13.5 2.5M11.5 4.5l1.5 1.5M9.5 6.5L11 8"/></svg>`,
  }
  ...
  let sections = $derived(!$user ? [] : [
    {
      ...
      items: [
        ...
        ...($user.role !== 'student' ? [
          ...
          { icon: I.key,     label: $t('nav.manageAiKeys'), href: '/exams/generate/keys', active: $page.url.pathname === '/exams/generate/keys' },
